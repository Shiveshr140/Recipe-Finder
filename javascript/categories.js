  ...
  if (main && categoriesLinks) {
    ...
    categoriesLinks.forEach((link) => {
      link.addEventListener("click", async (e) => {
        ...
        await displayCategoriesRecipesContent(category);
        ...
        backButton.addEventListener("click", () => {
          ...
          const restoredHealthyLink = main.querySelector(".dropdown");
...
async function displayCategoriesRecipesContent(category) {
  try {
    const recipes = await categoriesRecipes(category); // Fetch recipes by category
